...
| [verdict-cockpit](https://github.com/mrnicholasbcarter-code/verdict-cockpit) | `verdict-cockpit` | — | — | `0.1.0` | private application — not distributed | **not published** | node unspecified | alpha | experimental | 2026-09-26T00:36:22Z | `53cd186186b8725614f94667a2acdb8d7048456e` | not applicable |
