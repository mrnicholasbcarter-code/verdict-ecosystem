...
**Base SHA:** `e17a92062bc5ba9d7d0d8709535bc3412be31ba9` (after BOD-193: re-snapshot capturing ADR-035 and ADR-036).
...
|---|---|---|
| verdict-core | origin/main | e17a92062bc5ba9d7d0d8709535bc3412be31ba9 |
...
Captured at `2026-09-25T12:34:48.782766Z`. Branch refs are provenance labels at
...
**verdict-core snapshot updated to e17a920.** The previous core snapshot (cae6aa6) was from 2026-09-23, before ADR-035 and ADR-036. This re-snapshot (BOD-193) captures the current orchestration authority ADR-036 (goal-to-receipt orchestration, merged via #590 at 4617445) and ADR-035 (authorized selected-route dispatch, successor to ADR-023 closing BOD-169 MISSING_SUCCESSOR). ADR-023 now explicitly names ADR-035 as successor, removing the MISSING_SUCCESSOR classification. Legacy architecture ADRs in docs/architecture/ (ADR-EVIDENCE-LEDGER, ADR-ORCHESTRATOR-ROUTING) were deleted from core between snapshots and have been removed from the index (they remain in verdict-core-memory as historical duplicates). Both new ADRs are classified PARTIALLY_TRUE pending ecosystem re-audit.
...
| Metric | Value |
|---|---|
| Raw ADR-like files discovered | 74 |
| Benchmark fixtures excluded | 1 |
| Production files audited | 73 |
| Exact duplicate SHA-256 groups | 21 |
| Files covered by exact duplicates | 42 |
...
| Level | Meaning | Count |
|---|---|---|
| VERIFIED | Exact path/hash/code evidence at the snapshot | 57 |
| INFERRED | Namespace/logical inference, not byte-identity or test proof | 6 |
...
| `verdict-core@e17a92062bc5ba9d7d0d8709535bc3412be31ba9:docs/adr/0001-verdict-control-plane-invariants.md` | PARTIALLY_TRUE | VERIFIED | ACTIVE |
| `verdict-core@e17a92062bc5ba9d7d0d8709535bc3412be31ba9:docs/adr/ADR-001-evidence-ledger.md` | PARTIALLY_TRUE | VERIFIED | ACTIVE |
| `verdict-core@e17a92062bc5ba9d7d0d8709535bc3412be31ba9:docs/adr/ADR-002-orchestrator-routing.md` | PARTIALLY_TRUE | VERIFIED | ACTIVE |
| `verdict-core@e17a92062bc5ba9d7d0d8709535bc3412be31ba9:docs/adr/ADR-003-platform-neutral-guidance-boundary.md` | PARTIALLY_TRUE | VERIFIED | ACTIVE |
| `verdict-core@e17a92062bc5ba9d7d0d8709535bc3412be31ba9:docs/adr/ADR-004-local-first-memory-plane.md` | PARTIALLY_TRUE | VERIFIED | ACTIVE |
| `verdict-core@e17a92062bc5ba9d7d0d8709535bc3412be31ba9:docs/adr/ADR-005-code-intelligence-graph-memory-bridge.md` | PARTIALLY_TRUE | VERIFIED | ACTIVE |
| `verdict-core@e17a92062bc5ba9d7d0d8709535bc3412be31ba9:docs/adr/ADR-006-authoritative-documentation-preflight.md` | PARTIALLY_TRUE | NOT_VERIFIED | ACTIVE |
| `verdict-core@e17a92062bc5ba9d7d0d8709535bc3412be31ba9:docs/adr/ADR-007-omniroute-catalog-qualification.md` | PARTIALLY_TRUE | VERIFIED | ACTIVE |
| `verdict-core@e17a92062bc5ba9d7d0d8709535bc3412be31ba9:docs/adr/ADR-008-global-runtime-ownership.md` | PARTIALLY_TRUE | NOT_VERIFIED | ACTIVE |
| `verdict-core@e17a92062bc5ba9d7d0d8709535bc3412be31ba9:docs/adr/ADR-009-durable-memory-write-gate.md` | PARTIALLY_TRUE | VERIFIED | ACTIVE |
| `verdict-core@e17a92062bc5ba9d7d0d8709535bc3412be31ba9:docs/adr/ADR-010-fail-closed-capability-passports.md` | PARTIALLY_TRUE | VERIFIED | ACTIVE |
| `verdict-core@e17a92062bc5ba9d7d0d8709535bc3412be31ba9:docs/adr/ADR-011-omniroute-catalog-qualification-baseline.md` | PARTIALLY_TRUE | VERIFIED | ACTIVE |
| `verdict-core@e17a92062bc5ba9d7d0d8709535bc3412be31ba9:docs/adr/ADR-012-consented-budgeted-probes.md` | PARTIALLY_TRUE | VERIFIED | ACTIVE |
| `verdict-core@e17a92062bc5ba9d7d0d8709535bc3412be31ba9:docs/adr/ADR-013-independent-protocol-surface-qualification.md` | PARTIALLY_TRUE | VERIFIED | ACTIVE |
| `verdict-core@e17a92062bc5ba9d7d0d8709535bc3412be31ba9:docs/adr/ADR-014-tool-and-structured-output-qualification.md` | PARTIALLY_TRUE | VERIFIED | ACTIVE |
| `verdict-core@e17a92062bc5ba9d7d0d8709535bc3412be31ba9:docs/adr/ADR-015-evidence-authority-and-portable-receipts.md` | PARTIALLY_TRUE | VERIFIED | ACTIVE |
| `verdict-core@e17a92062bc5ba9d7d0d8709535bc3412be31ba9:docs/adr/ADR-016-deterministic-policy-and-transition-graphs.md` | PARTIALLY_TRUE | VERIFIED | ACTIVE |
| `verdict-core@e17a92062bc5ba9d7d0d8709535bc3412be31ba9:docs/adr/ADR-017-durable-privacy-safe-receipt-ledger.md` | PARTIALLY_TRUE | VERIFIED | ACTIVE |
| `verdict-core@e17a92062bc5ba9d7d0d8709535bc3412be31ba9:docs/adr/ADR-018-shadow-and-counterfactual-evaluation.md` | PARTIALLY_TRUE | NOT_VERIFIED | ACTIVE |
| `verdict-core@e17a92062bc5ba9d7d0d8709535bc3412be31ba9:docs/adr/ADR-019-runtime-negotiated-passports.md` | PARTIALLY_TRUE | VERIFIED | ACTIVE |
| `verdict-core@e17a92062bc5ba9d7d0d8709535bc3412be31ba9:docs/adr/ADR-020-gateway-adapter-contracts.md` | PARTIALLY_TRUE | NOT_VERIFIED | ACTIVE |
| `verdict-core@e17a92062bc5ba9d7d0d8709535bc3412be31ba9:docs/adr/ADR-021-deterministic-provider-receipts.md` | PARTIALLY_TRUE | VERIFIED | ACTIVE |
| `verdict-core@e17a92062bc5ba9d7d0d8709535bc3412be31ba9:docs/adr/ADR-022-context-provider-conformance.md` | PARTIALLY_TRUE | VERIFIED | ACTIVE |
| `verdict-core@e17a92062bc5ba9d7d0d8709535bc3412be31ba9:docs/adr/ADR-023-governed-swarm-supervision.md` | SUPERSEDED | VERIFIED | ACTIVE |
| `verdict-core@e17a92062bc5ba9d7d0d8709535bc3412be31ba9:docs/adr/ADR-024-cross-repo-compatibility-gate.md` | PARTIALLY_TRUE | NOT_VERIFIED | ACTIVE |
| `verdict-core@e17a92062bc5ba9d7d0d8709535bc3412be31ba9:docs/adr/ADR-025-node-envelope-enforcement.md` | PARTIALLY_TRUE | VERIFIED | ACTIVE |
| `verdict-core@e17a92062bc5ba9d7d0d8709535bc3412be31ba9:docs/adr/ADR-026-responses-compatibility-boundary.md` | PARTIALLY_TRUE | VERIFIED | ACTIVE |
| `verdict-core@e17a92062bc5ba9d7d0d8709535bc3412be31ba9:docs/adr/ADR-027-observed-free-status-and-context-omissions.md` | PARTIALLY_TRUE | VERIFIED | ACTIVE |
| `verdict-core@e17a92062bc5ba9d7d0d8709535bc3412be31ba9:docs/adr/ADR-028-launch-gate-tooling.md` | PARTIALLY_TRUE | NOT_VERIFIED | ACTIVE |
| `verdict-core@e17a92062bc5ba9d7d0d8709535bc3412be31ba9:docs/adr/ADR-029-portfolio-repositioning-plan.md` | PARTIALLY_TRUE | NOT_VERIFIED | ACTIVE |
| `verdict-core@e17a92062bc5ba9d7d0d8709535bc3412be31ba9:docs/adr/ADR-030-proof-carrying-decision-plane.md` | PARTIALLY_TRUE | NOT_VERIFIED | ACTIVE |
| `verdict-core@e17a92062bc5ba9d7d0d8709535bc3412be31ba9:docs/adr/ADR-031-prime-workflow-skills.md` | PARTIALLY_TRUE | VERIFIED | ACTIVE |
| `verdict-core@e17a92062bc5ba9d7d0d8709535bc3412be31ba9:docs/adr/ADR-032-core-model-metadata-store.md` | PARTIALLY_TRUE | VERIFIED | ACTIVE |
| `verdict-core@e17a92062bc5ba9d7d0d8709535bc3412be31ba9:docs/adr/ADR-033-shared-memory-provider.md` | PARTIALLY_TRUE | VERIFIED | ACTIVE |
| `verdict-core@e17a92062bc5ba9d7d0d8709535bc3412be31ba9:docs/adr/ADR-034-memory-outbox-mirror-and-fail-open-shared-recall.md` | PARTIALLY_TRUE | VERIFIED | ACTIVE |
| `verdict-core@e17a92062bc5ba9d7d0d8709535bc3412be31ba9:docs/adr/ADR-035-authorized-selected-route-dispatch.md` | PARTIALLY_TRUE | VERIFIED | ACTIVE |
| `verdict-core@e17a92062bc5ba9d7d0d8709535bc3412be31ba9:docs/adr/ADR-036-goal-to-receipt-orchestration.md` | PARTIALLY_TRUE | VERIFIED | ACTIVE |
| `verdict-core@e17a92062bc5ba9d7d0d8709535bc3412be31ba9:docs/adr/ADR-ORCHESTRATOR-ROUTING.md` | SUPERSEDED | VERIFIED | ACTIVE |
| `verdict-core@e17a92062bc5ba9d7d0d8709535bc3412be31ba9:docs/adr/README.md` | INVALID | VERIFIED | ACTIVE |
