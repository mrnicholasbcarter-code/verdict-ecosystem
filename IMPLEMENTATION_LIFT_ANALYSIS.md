...
| Model assignment | Adaptive ranker, catalog, intelligence service | Core, OmniRoute, Node, Ruflo | Build policy-bounded slice assignment after eligibility | L | High | Decision Kernel, capability data |
