...
| Model assignment | Adaptive ranker, intelligence service, catalog, capability qualification | Ranking and assignment are not exposed as a policy-bounded slice-assignment engine | Add `ModelAssignmentEngine` after eligibility; record rationale and model/provider attribution | L |
